            ...
            <div className='container mx-auto px-3 md:px-10'>
                <div className='px-5 py-32'>
                    ...
                    <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'>
                        Immerse Yourself in a rich and ever-expending universe where a vibrant array of prodcuts converge into a interconnected overlay experience on your world.
                    </p>
                </div>
                ...
                <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
                    ...
                    <BentoTilt className='bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0'>
                        <BentoCard
                            ...
                            title={<>n<b>e</b>xus</>}
                            description="A gamified social hub, ading a new dimension of play to social interaction for Web3 communities. "
                        />
                    </BentoTilt>
